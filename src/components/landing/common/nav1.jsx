...
function Nav1({Nav, setNav}) {
  ...
  return (
    <div>
          ...
          <button
            ...
            <svg 
              ...
              viewBox="0 0 32 32">
                <path 
                  fill="currentColor" 
                  d="M7.219 5.781L5.78 7.22L14.563 16L5.78 24.781l1.44 1.439L16 17.437l8.781 8.782l1.438-1.438L17.437 16l8.782-8.781L24.78 5.78L16 14.563z"/></svg>
          </button>
        </div>
            ...
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                viewBox="0 0 15 15">
                  ...
                  <path d="M7.5 3.958c2.17 0 4.375.401 5.87 1.236a.35.35 0 1 1-.34.612c-1.35-.754-3.422-1.148-5.53-1.148s-4.18.394-5.53 1.148a.35.35 0 1 1-.34-.612c1.495-.835 3.7-1.236 5.87-1.236zm0 6.892c2.17 0 4.375-.401 5.87-1.236a.35.35 0 1 0-.34-.612c-1.35.754-3.422 1.148-5.53 1.148s-4.18-.394-5.53-1.148a.35.35 0 1 0-.34.611c1.495.836 3.7 1.237 5.87 1.237z"/></g></svg>
            </span>
            <span>
      ...
      {/* nav fro silmualtion at small screens */}
      <div className="nav">
        <a href="/">
          <img 
